...
The codes were also embedded into the brainmaze_eeg Toolbox so they can be freely available upon installing the whole `Brainmaze EEG <https://github.com/bnelair/brainmaze_eeg/>`_ library. The documentation to the toolbox is available at `<https://bnelair.github.io/brainmaze_eeg>`_.
